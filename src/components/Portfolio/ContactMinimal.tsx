      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="bg-card/50 backdrop-blur-sm border-2 border-accent rounded-2xl p-8 hover:shadow-[0_0_30px_rgba(22,255,0,0.2)] transition-all duration-300">
              <div className="flex items-center justify-center mb-6">
                <div className="p-4 bg-[#25D366] rounded-full">
              ...
              <a
                ...
                className="block"
              >
                <Button className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white py-6 text-lg font-bold flex items-center justify-center gap-3 group">
