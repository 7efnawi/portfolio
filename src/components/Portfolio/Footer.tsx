      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold mb-4">Alex Chen</h3>
            <p className="text-primary-foreground/80 text-lg mb-6 max-w-2xl mx-auto">
              AI Engineer & Data Scientist passionate about creating intelligent solutions 
              that make a meaningful impact on businesses and society.
            </p>
